...
import signup, { addProfilePic, applyJob, getProfile, getUserMetrics, initializeWallet, login, logout, sendOTP, verifyOTP,forgotPassword,resetPassword, getUserPosts, userSearch, getSearchedUserPosts,addCoverPic, sendMobileOtp, verifyMobileOtp, deactivateUserAccount, getProfileById, deleteProfilePic, deleteCoverPic, payFromWallet, verifyCredentials, redeemPoints} from '../controllers/userController.js'; // Adjust the path
